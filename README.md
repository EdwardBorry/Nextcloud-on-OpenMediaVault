![OpenMediaVault](https://img.shields.io/badge/OpenMediaVault-7.x-5DACDF?style=for-the-badge)
...
# Important
The documentation doesn't aim to be a complete documentation with a detailed investigation of each point in OpenMediaVault and nextcloud, instead there's a solution of making a NAS server for daily usage only (e.g. disks configuration, users management...).
